...
- **[EXTERNAL_HARNESS_INTEGRATION_GUIDE.md](./EXTERNAL_HARNESS_INTEGRATION_GUIDE.md)** — connect an external agent such as Claude Code as a second participant in the same agent chat
