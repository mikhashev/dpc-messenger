...
| **network** | ADR-040 accepted · ADR-041 accepted | 182 | 40 |
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 147 | 32 |
| **reach** | ADR-035 accepted | 23 | 5 |

**Observation debt: 137 under an axis + 18 in entries that carry none = 155.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
