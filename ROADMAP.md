...
| **network** | ADR-040 accepted · ADR-041 accepted | 183 | 39 |
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 141 | 26 |
| **reach** | ADR-035 accepted | 24 | 6 |

**Observation debt: 131 under an axis + 18 in entries that carry none = 149.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
