...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 147 | 29 |
| **reach** | ADR-035 accepted | 23 | 5 |

**Observation debt: 130 under an axis + 18 in entries that carry none = 148.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
