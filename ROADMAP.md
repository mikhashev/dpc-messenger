...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted | 135 | 32 |
...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted | 100 | 20 |
| **reach** | ADR-035 accepted | 17 | 4 |

**Observation debt: 88 under an axis + 18 in entries that carry none = 106.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 592 board entries carry no axis, and a guessed one would report coverage this does not have.
