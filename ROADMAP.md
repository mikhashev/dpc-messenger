...
| **network** | ADR-040 accepted · ADR-041 accepted | 176 | 34 |
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 140 | 25 |
| **reach** | ADR-035 accepted | 24 | 6 |

**Observation debt: 125 under an axis + 18 in entries that carry none = 143.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 734 board entries carry no axis, and a guessed one would report coverage this does not have.
