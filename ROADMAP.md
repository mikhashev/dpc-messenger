...
retypes is a status that can quietly stop being true — and once did, for six weeks, about
enforcement this code does not have (Protocol 13 rule 13, invariant И2).
