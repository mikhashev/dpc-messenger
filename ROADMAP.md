...
| **knowledge** | ADR-028 accepted · ADR-029 accepted · ADR-030 implemented · ADR-033 implemented · ADR-034 accepted | 109 | 21 |
| **network** | ADR-040 accepted · ADR-041 accepted | 120 | 17 |
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 113 | 25 |
| **reach** | ADR-035 accepted | 24 | 5 |

**Observation debt: 103 under an axis + 18 in entries that carry none = 121.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 635 board entries carry no axis, and a guessed one would report coverage this does not have.
