...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted | 116 | 21 |
...
Not yet placed: 130 of 555 board entries carry no axis, and a guessed one would report coverage this does not have.
