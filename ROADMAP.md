...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted | 134 | 32 |
...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted | 98 | 20 |
...
Not yet placed: 130 of 589 board entries carry no axis, and a guessed one would report coverage this does not have.
