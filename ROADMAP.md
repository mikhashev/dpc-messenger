...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 180 | 41 |
| **reach** | ADR-035 accepted · ADR-043 proposed | 27 | 8 |

**Observation debt: 159 under an axis + 19 in entries that carry none = 178.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
