...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted | 141 | 37 |
...
**Observation debt: 95 under an axis + 18 in entries that carry none = 113.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 601 board entries carry no axis, and a guessed one would report coverage this does not have.
