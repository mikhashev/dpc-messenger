...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted | 114 | 21 |
...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted | 89 | 17 |
...
Not yet placed: 130 of 550 board entries carry no axis, and a guessed one would report coverage this does not have.
