...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted | 88 | 17 |
| **reach** | ADR-035 accepted | 12 | 3 |

**Observation debt: 74 under an axis + 18 in entries that carry none = 92.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 547 board entries carry no axis, and a guessed one would report coverage this does not have.
