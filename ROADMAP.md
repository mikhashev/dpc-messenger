...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted · ADR-042 accepted | 172 | 51 |
...
**Observation debt: 166 under an axis + 19 in entries that carry none = 185.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
