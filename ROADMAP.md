...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 184 | 44 |
| **reach** | ADR-035 accepted · ADR-043 proposed | 27 | 8 |

**Observation debt: 171 under an axis + 19 in entries that carry none = 190.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
