...
| **network** | ADR-040 accepted · ADR-041 accepted | 189 | 42 |
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 155 | 35 |
| **reach** | ADR-035 accepted | 25 | 6 |

**Observation debt: 141 under an axis + 18 in entries that carry none = 159.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.

Not yet placed: 130 of 758 board entries carry no axis, and a guessed one would report coverage this does not have.
