...
|---|---|---|---|
| **collective** | ADR-031 accepted · ADR-032 accepted · ADR-036 accepted · ADR-037 accepted · ADR-038 accepted · ADR-042 accepted | 152 | 40 |
...
| **honesty** | ADR-027 proposed · ADR-039 accepted · ADR-041 accepted · ADR-042 accepted | 131 | 20 |
| **reach** | ADR-035 accepted | 25 | 6 |

**Observation debt: 116 under an axis + 18 in entries that carry none = 134.** Work finished and never seen working; per axis it says which direction is running ahead of its evidence.
